...
class App extends Component {
  //we maintain the active status here in the state
  state = {
  ...
  // here we filtered the projects based on the category and tabId
  getFilteredProjects = () => {
    ...
    return (
      <div className="app-container">
        ...
        <ul className="project-list-container">
          {/*now replace the projectsList to  filteredProjects*/}
